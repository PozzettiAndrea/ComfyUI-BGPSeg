...
"""
Logging infrastructure for BGPSeg operations.
"""
...
logger = logging.getLogger("BGPSeg")
...
def setup_logging(level: int = logging.INFO, log_file: str = None):
    ...
    if not logger.handlers:
        ...
        console.setFormatter(logging.Formatter("[%(asctime)s] [BGPSeg] %(message)s", datefmt="%H:%M:%S"))
